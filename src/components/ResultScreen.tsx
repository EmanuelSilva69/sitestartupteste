                ...
                <div className="p-5 flex items-start gap-4 relative">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-emerald-200/90">
                      Número de Inscrição: <span className="font-bold text-white">{inscription}</span>
                    </p>
                  </div>
                </div>
              </Card>
                ...
                <div className="p-8 relative">
                  ...
                  <div className="mt-8 flex items-center justify-end">
                    <div className="flex items-center gap-2 text-primary font-bold group-hover:gap-3 transition-all">
                      ...
                      <span className="text-base">Ver detalhes completos</span>
              ...
              <div className="p-20 relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-lg text-foreground/80 mb-3 max-w-md">
                    Não encontramos nenhuma inscrição com o número
                  </p>
